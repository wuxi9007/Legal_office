class PersonnelsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @personnel.save
        format.html { redirect_to personnels_path, notice: 'Personnel was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @personnel.update(personnel_params)
        format.html { redirect_to personnels_path, notice: 'Personnel was successfully updated.' }
